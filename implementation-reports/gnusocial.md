...
Developer(s): [Stephen Paul Weber](https://singpolyma.net)
...
* [x] HTML
* [x] Other: Any text-based format contaning the URL
 ...
 * [x] using HTML markup: `class="u-in-reply-to"` or `rel="in-reply-to"`
 ...
 * [x] using HTML markup: `class="u-in-reply-to"` and `class="p-rsvp"`
