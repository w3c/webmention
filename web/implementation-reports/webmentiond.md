...
Implementation Home Page URL: https://webmentiond.org

Source Code repo URL(s) (optional): https://github.com/zerok/webmentiond
* [x] 100% open source implementation

Programming Language(s): Go, JavaScript

Developer(s): [Horst Gutmann](https://zerokspot.com)
...
* [na] [Update Test #1](https://webmention.rocks/update/1)
* [na] [Update Test #2](https://webmention.rocks/update/2)

#### Implementation Notes

Webmentiond does not keep any state for sending mentions to external URLs.
...
* [na] [Delete Test #1](https://webmention.rocks/delete/1)
